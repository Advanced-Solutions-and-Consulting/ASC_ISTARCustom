...
namespace iStarCustom
{
    ...
    public class InfoINKitSpecHdriStarVendorQuote : IBqlTable
    {
        ...
        [PXParent(typeof(Select<INKitSpecHdr,
          Where<INKitSpecHdr.kitInventoryID, Equal<Current<InfoINKitSpecHdriStarVendorQuote.kitInventoryID>>, And<INKitSpecHdr.revisionID, Equal<Current<InfoINKitSpecHdriStarVendorQuote.revisionID>>>>>))]
